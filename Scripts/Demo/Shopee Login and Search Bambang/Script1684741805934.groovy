...
WebUI.click(findTestObject('Object Repository/Page_Shopee Indonesia  Situs Belanja Online_073d3b/a_Log In'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login sekarang untuk mulai berbelanja _a6a865/input_Log in dengan QR_password'), 
    'gvq2axvRWBnJKFxl0Wq//w==')

WebUI.click(findTestObject('Object Repository/Page_Login sekarang untuk mulai berbelanja _a6a865/button_Log in'))

WebUI.setText(findTestObject('Object Repository/Page_Shopee Indonesia  Situs Belanja Online_073d3b/input_malik96ka_shopee-searchbar-input__input'), 
    'Bambang')

WebUI.click(findTestObject('Object Repository/Page_Shopee Indonesia  Situs Belanja Online_073d3b/button_malik96ka_btn btn-solid-primary btn-_e878bd'))
